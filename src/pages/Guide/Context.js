...
export default function Context({left, leftLink, right, rightLink}){
    ...
    <div className="col-8 p-5">
        ...
        <div className="d-flex p-5" style={{justifyContent:'center'}}><img src="img/Images/org.jpg" style={{maxHeight:'400px'}}></img></div>
        ...
        <h3>4.2 Understanding the needs and expectations of interested parties</h3>
        ...
        <h3>4.4 Food Safety Management System</h3>
