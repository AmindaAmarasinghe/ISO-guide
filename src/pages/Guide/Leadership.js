...
export default function Leadership({left, leftLink, right, rightLink}){
    ...
    <div className="col-8 p-5">
        ...
        <div className="d-flex p-5" style={{justifyContent:'center'}}><img src="img/Images/leader.jpg" style={{maxHeight:'400px'}}></img></div>
        ...
        <h3>5.2 Policy</h3>
        <h4>5.2.1 Establishing the food safety policy</h4>
        ...
        <h4>5.2.2  Communicating the food safety policy</h4>
        <ul>
        ...
        <h4>5.3.1</h4> The top management of your organization shall assign responsibilities and authorities for relevant roles and make sure that they are communicated and understood well among all the employees within the organization.
        ...
        <h4>5.3.2</h4> Responsibilities of food safety team leader,
        <ul>
        ...
        <h4>5.3.3</h4> All the employees have the responsibility to report problems relevant to FSMS to identified person(s).
